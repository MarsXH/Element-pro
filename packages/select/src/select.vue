  ...
  >
    ...
    >
      <el-select-menu
        ...
        :extend-position="extendPosition"
        :extend-text-left="extendTextLeft"
        :extend-text-right="extendTextRight"
      >
        <el-scrollbar
          tag="ul"
        ...
        <template v-if="$slots.extend" slot="extend">
...
import Focus from "element-pro/src/mixins/focus";
import Locale from "element-pro/src/mixins/locale";
// utils
import Clickoutside from "element-pro/src/utils/clickoutside";
import {
  addResizeListener,
  removeResizeListener,
} from "element-pro/src/utils/resize-event";
import scrollIntoView from "element-pro/src/utils/scroll-into-view";
import {
  getValueByPath,
  valueEquals,
  isIE,
  isEdge,
} from "element-pro/src/utils/util";
import { isKorean } from "element-pro/src/utils/shared";
...
export default {
  ...
  mounted() {
    ...
    this.setSelected();
    const menu = this.$refs.scrollbar.$el.querySelector(
      ".el-select-dropdown__wrap"
    );
